...
if ($default_logo != ''){
	if ($retina_logo ){
		...
		echo '<a href="'. esc_url(home_url()) .'" class="header-default-css"><img class="static" src="'. esc_attr($default_logo) .'" alt="', esc_attr(bloginfo('name')) .'" style="height:48px;width:240px;" /></a>';
	}
} else {
